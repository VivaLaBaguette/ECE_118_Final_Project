...
//ACTUALY BOARD BEACON VALUES
#define BEACON_2KHZ_DETECTED_THRESHOLD 830
#define BEACON_2KHZ_NOT_THRESHOLD 750
...
#define BEACON_2KHZ_CLOSE_DETECTED_THRESHOLD 880
